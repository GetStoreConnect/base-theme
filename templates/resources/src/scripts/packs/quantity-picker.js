...
// Greedy buttons steal pointer events from the quantity picker
// and prevent the user from clicking on the quantity picker.
// This is a workaround to prevent the user from clicking on the
// greedy buttons when the quantity picker is visible.
