(() => {
      ...
      (function(root, factory) {
        ...
        var hasMoment = typeof moment === "function", hasEventListeners = !!window.addEventListener, document2 = window.document, sto = window.setTimeout, addEvent = function(el, e, callback, capture) {
          ...
          if (opts.keyboardInput) {
            addEvent(document2, "keydown", self._onKeyChange);
          }
          if (opts.field) {
            if (opts.container) {
  ...
  // src/scripts/packs/date-picker.js
  ...
  function init(node) {
    ...
    [...node.querySelectorAll("[data-date-picker]")].forEach(
      (elem) => new import_pikaday.default({ field: elem, format: "YYYY-MM-DD", minDate: /* @__PURE__ */ new Date() })
    );
  }
})();
...
pikaday/pikaday.js:
   ...
   *)
*/
//# sourceMappingURL=date-picker.PIMJXNE6.js.map
