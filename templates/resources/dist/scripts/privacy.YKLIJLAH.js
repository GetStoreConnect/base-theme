(() => {
  ...
  function enableOrDisableAllCookies(event) {
    ...
    if (event.target.checked === true) {
      ...
      [...cookieLabels].map((label2) => label2.innerText = label2.dataset.enabledLabel);
    } else {
      event.target.checked = false;
      label.innerText = label.dataset.enableLabel;
      [...cookieLabels].map((label2) => label2.innerText = label2.dataset.disabledLabel);
    }
    ;
    [...cookies].map((cookie) => {
...
//# sourceMappingURL=privacy.YKLIJLAH.js.map
