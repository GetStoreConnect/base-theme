(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      initCboss({ form, providerId: providerId2 });
    });
  });
  function initCboss({ form, providerId: providerId2 }) {
    basicInit("Cboss", providerId2);
    ...
    addFormInput("ClientAccount", form.dataset.clientAccount);
    addFormInput("OriginatorID", form.dataset.originatorId);
    addFormInput("SuccessfulURL", form.dataset.callbackUrl);
    addFormInput("UnsuccessfulURL", form.dataset.callbackUrl);
    addFormInput("FirstName", form.dataset.firstName);
    addFormInput("LastName", form.dataset.lastName);
    addFormInput("BillingAddressLine1", form.dataset.billingAddressLine1);
    addFormInput("BillingEmail", form.dataset.billingEmail);
    addFormInput("BillingCity", form.dataset.billingCity);
    addFormInput("BillingCountry", form.dataset.billingCountry);
    addFormInput("BillingZip", form.dataset.billingZip);
    addFormInput("BillingPhoneNumber", form.dataset.billingPhoneNumber);
    addFormInput("BillingState", form.dataset.billingState);
    addFormInput("Currency", form.dataset.currency);
    addFormInput("Amount", totalPayable());
    addFormInput("Number", form.dataset.number);
    addFormInput("PaymentType", form.dataset.paymentType);
  }
})();
//# sourceMappingURL=cboss.GEQTUD2Z.js.map
