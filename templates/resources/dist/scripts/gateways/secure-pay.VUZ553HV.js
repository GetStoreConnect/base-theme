(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      initSecurePay({ form, providerId: providerId2 });
    });
  });
  ...
  function initSecurePay({ form, providerId: providerId2 }) {
    var mySecurePayUI;
    init("SecurePay", providerId2, function() {
      mySecurePayUI.tokenise();
    });
    const inputStyles = form.dataset.inputStyles ? JSON.parse(form.dataset.inputStyles) : defaultInputStyles();
...
//# sourceMappingURL=secure-pay.VUZ553HV.js.map
