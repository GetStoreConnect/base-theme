(() => {
  ...
  function initSecurePay({ form: form2, providerId: providerId2 }) {
    ...
    var securepayUiUrl = isProduction() ? "https://payments.auspost.net.au/v3/ui/client/securepay-ui.min.js" : "https://payments-stest.npe.auspost.zone/v3/ui/client/securepay-ui.min.js";
    loadScript({
      url: securepayUiUrl,
      id: scriptId,
      onload: function() {
...
//# sourceMappingURL=secure-pay.V5NHH7SN.js.map
