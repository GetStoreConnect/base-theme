(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      initBambora({ providerId: providerId2 });
    });
  });
  function initBambora({ providerId: providerId2 }) {
    ...
    init("Bambora", providerId2, createToken);
...
//# sourceMappingURL=bambora.PIUE4ZIL.js.map
