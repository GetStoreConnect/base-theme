(() => {
  ...
  window.StoreConnect.Gateways.Paypal = function({ providerId: providerId2 }) {
    init("Paypal", providerId2, null, setPayButton2);
    function paypalButton() {
      return document.getElementById(`PaypalButton${providerId2}`);
    }
...
@paypal/paypal-js/dist/esm/paypal-js.js:
   ...
   *)
*/
//# sourceMappingURL=paypal.XTAXTGHJ.js.map
