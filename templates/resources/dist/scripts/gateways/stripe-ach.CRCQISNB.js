(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form2) => {
      ...
      if (providerId2) {
        initStripeAch({ form: form2, providerId: providerId2 });
      }
    });
  });
  function initStripeAch({ form: form2, providerId: providerId2 }) {
    init(form2, stripeCreatePaymentIntent);
    let stripe;
    ...
    function stripeCreatePaymentIntent(form3) {
      let data = {
        payment: {
      ...
      const url = `${form3.getAttribute("action")}/ach`;
...
//# sourceMappingURL=stripe-ach.CRCQISNB.js.map
