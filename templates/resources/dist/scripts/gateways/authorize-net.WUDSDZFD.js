(() => {
  ...
  function initAuthorizeNet({ form: form2 }) {
    ...
    const authorizeNetUrl = isProduction() ? "https://js.authorize.net/v1/Accept.js" : "https://jstest.authorize.net/v1/Accept.js";
    loadScript({ url: authorizeNetUrl });
  }
})();
//# sourceMappingURL=authorize-net.WUDSDZFD.js.map
