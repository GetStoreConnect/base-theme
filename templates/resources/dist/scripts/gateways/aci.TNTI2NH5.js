(() => {
  ...
  window.StoreConnect.Gateways.Aci = async function({ providerId: providerId2, providerName: providerName2 }) {
    basicInit(providerName2, providerId2);
    ...
    addFormInput("cde-Name-0", formElement().dataset.uniqueId);
    addFormInput("productId", formElement().dataset.productId);
    addFormInput("paymentAmount", totalPayable());
    addFormInput("postbackUrl", formElement().dataset.postbackUrl);
    addFormInput("returnUrl", formElement().dataset.returnUrl);
    addFormInput("errorUrl", formElement().dataset.cancelUrl);
    addFormInput("cancelUrl", formElement().dataset.cancelUrl);
    addFormInput("firstName", formElement().dataset.firstName);
    addFormInput("lastName", formElement().dataset.lastName);
    addFormInput("email", formElement().dataset.billingEmail);
  };
})();
//# sourceMappingURL=aci.TNTI2NH5.js.map
