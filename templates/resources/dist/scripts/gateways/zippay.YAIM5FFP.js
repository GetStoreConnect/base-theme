(() => {
  ...
  window.StoreConnect.Gateways.initZippay = function({ providerId: providerId2 }) {
    init("Zippay", providerId2);
    const zipCheckoutId = `#ZippayPayWithButton${providerId2}`;
...
//# sourceMappingURL=zippay.YAIM5FFP.js.map
