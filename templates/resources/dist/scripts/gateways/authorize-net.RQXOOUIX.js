(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      if (providerId2) {
        initAuthorizeNet({ form, providerId: providerId2 });
      }
    });
  });
  function initAuthorizeNet({ form, providerId: providerId2 }) {
    const providerName2 = form.dataset.provider;
    const zipCode = form.dataset.zipCode;
    init(providerName2, providerId2, createToken);
    const authData = {
      apiLoginID: apiKey(),
...
//# sourceMappingURL=authorize-net.RQXOOUIX.js.map
