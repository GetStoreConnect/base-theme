(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form2) => {
      ...
      initEwayV2({ providerId: providerId2, form: form2 });
    });
  });
  function initEwayV2({ providerId: providerId2, form: form2 }) {
    init(form2, showEwayModal);
    const redirectUrl = form2.dataset.redirectUrl;
...
//# sourceMappingURL=eway-v2.EXPYRMSF.js.map
