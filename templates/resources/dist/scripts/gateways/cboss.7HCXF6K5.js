(() => {
  ...
  function addFormInput({ form: form2, name, value }) {
  ...
  function initCboss({ form: form2 }) {
    basicInit(form2);
    addFormInput({ form: form2, name: "ClientAccount", value: form2.dataset.clientAccount });
    addFormInput({ form: form2, name: "OriginatorID", value: form2.dataset.originatorId });
    addFormInput({ form: form2, name: "SuccessfulURL", value: form2.dataset.callbackUrl });
    addFormInput({ form: form2, name: "UnsuccessfulURL", value: form2.dataset.callbackUrl });
    addFormInput({ form: form2, name: "FirstName", value: form2.dataset.firstName });
    addFormInput({ form: form2, name: "LastName", value: form2.dataset.lastName });
    addFormInput({ form: form2, name: "BillingAddressLine1", value: form2.dataset.billingAddressLine1 });
    addFormInput({ form: form2, name: "BillingEmail", value: form2.dataset.billingEmail });
    addFormInput({ form: form2, name: "BillingCity", value: form2.dataset.billingCity });
    addFormInput({ form: form2, name: "BillingCountry", value: form2.dataset.billingCountry });
    addFormInput({ form: form2, name: "BillingZip", value: form2.dataset.billingZip });
    addFormInput({ form: form2, name: "BillingPhoneNumber", value: form2.dataset.billingPhoneNumber });
    addFormInput({ form: form2, name: "BillingState", value: form2.dataset.billingState });
    addFormInput({ form: form2, name: "Currency", value: form2.dataset.currency });
    addFormInput({ form: form2, name: "Amount", value: totalPayable() });
    addFormInput({ form: form2, name: "Number", value: form2.dataset.number });
    addFormInput({ form: form2, name: "PaymentType", value: form2.dataset.paymentType });
  }
})();
//# sourceMappingURL=cboss.7HCXF6K5.js.map
