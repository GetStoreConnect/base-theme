(() => {
  ...
  // src/scripts/packs/gateways/aci.js
  onDomChange((node) => {
  ...
  function initAci({ form: form2 }) {
    basicInit(form2);
    addFormInput({ form: form2, name: "cde-Name-0", value: form2.dataset.uniqueId });
    addFormInput({ form: form2, name: "productId", value: form2.dataset.productId });
    addFormInput({ form: form2, name: "paymentAmount", value: totalPayable() });
    addFormInput({ form: form2, name: "postbackUrl", value: form2.dataset.postbackUrl });
    addFormInput({ form: form2, name: "returnUrl", value: form2.dataset.returnUrl });
    addFormInput({ form: form2, name: "errorUrl", value: form2.dataset.cancelUrl });
    addFormInput({ form: form2, name: "cancelUrl", value: form2.dataset.cancelUrl });
    ...
    addFormInput({ form: form2, name: "email", value: form2.dataset.billingEmail });
  }
})();
//# sourceMappingURL=aci.ZHF6V32L.js.map
