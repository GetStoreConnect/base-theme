(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      initPayWay({ form, providerId: providerId2 });
    });
  });
  function initPayWay({ form, providerId: providerId2 }) {
    init("PayWay", providerId2, onSubmit);
    ...
    const tokenCallback = function(err, data) {
      if (err) {
        ...
        const div = document.getElementById(`PayWayPaymentError${providerId2}`);
...
//# sourceMappingURL=pay-way.5VGCYIWV.js.map
