(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      initBosch({ form, providerId: providerId2 });
    });
  });
  async function initBosch({ form, providerId: providerId2, providerName: providerName2 }) {
    basicInit("Bosch", providerId2);
...
//# sourceMappingURL=bosch.HVMM2HBA.js.map
