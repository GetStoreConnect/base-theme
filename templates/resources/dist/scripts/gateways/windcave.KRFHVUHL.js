(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      initWindcave({ providerId: providerId2 });
    });
  });
  function initWindcave({ providerId: providerId2 }) {
    init("Windcave", providerId2, onClick);
    function onClick() {
      fetch(callbackUrl(), {
        method: "post",
        headers: {
...
//# sourceMappingURL=windcave.KRFHVUHL.js.map
