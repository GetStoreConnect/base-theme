(() => {
  ...
  function initAci({ form: form2 }) {
    ...
    addFormInput("cde-Name-0", form2.dataset.uniqueId);
    addFormInput("productId", form2.dataset.productId);
    addFormInput("paymentAmount", totalPayable());
    addFormInput("postbackUrl", form2.dataset.postbackUrl);
    addFormInput("returnUrl", form2.dataset.returnUrl);
    addFormInput("errorUrl", form2.dataset.cancelUrl);
    addFormInput("cancelUrl", form2.dataset.cancelUrl);
    addFormInput("firstName", form2.dataset.firstName);
    addFormInput("lastName", form2.dataset.lastName);
    addFormInput("email", form2.dataset.billingEmail);
  }
})();
//# sourceMappingURL=aci.V5HAU3NS.js.map
