(() => {
  ...
  window.StoreConnect.Gateways.Bosch = async function({ providerId: providerId2, providerName: providerName2 }) {
    basicInit(providerId2, providerName2);
    const formId = `${providerId2}PaymentForm${providerName2}`;
    const buttonId = `${providerId2}PaymentButton${providerName2}`;
...
//# sourceMappingURL=bosch.GOPINX2I.js.map
