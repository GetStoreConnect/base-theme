(() => {
  ...
  onDomChange((node) => {
    ...
    forms.forEach((form) => {
      ...
      if (providerId2) {
        initSquare({ form, providerId: providerId2 });
      }
    });
  });
  async function initSquare({ form, providerId: providerId2 }) {
    init("Square", providerId2, createToken);
...
//# sourceMappingURL=square.242CBPYW.js.map
