(() => {
  ...
  function initStripe({ form: form2 }) {
    let dedicatedCartProductId2 = form2.dataset.cartProductId;
    init(form2, stripeCreateToken, null, dedicatedCartProductId2);
    let cardNumberElement;
    let stripe;
    let elements;
    function paymentsUrl() {
      return form2.dataset.paymentsUrl;
    }
    function intentsUrl() {
...
//# sourceMappingURL=stripe.3P66YDBT.js.map
